...
here: the **bundler plugins** (Vite, esbuild, Bun), **typed errors**, and **capability detection**. The rest (typed worker RPC, engine
lifecycle) is for building engines of your own.

**[Documentation](https://kucukkanat.github.io/speech/packages/core) · [Playground](https://kucukkanat.github.io/speech/playground)**
