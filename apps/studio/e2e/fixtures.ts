...
export const BASE_URL = "http://localhost:5460";
...
/**
 * A persistent Chromium profile so downloaded models survive between runs, with a fake microphone fed from a WAV
 * file: the real getUserMedia → AudioWorklet → worker → model path runs, only the sound source is a file.
 */
