---
title: "Voice library"
description: "A persistent voice library for @kucukkanat/tts: voices live in IndexedDB, come with two bundled demo voices, and remember their encodings so a saved voice speaks instantly after a reload."
icon: users
---

`@kucukkanat/voices` · [source](https://github.com/kucukkanat/speech/tree/main/packages/voices)
